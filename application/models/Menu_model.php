...
class Menu_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action',anchor(site_url('kelolamenu/update/$1'),'<i class="mdi mdi-tooltip-edit" aria-hidden="true"></i>', array('class' => 'btn btn-warning btn-circle btn-sm'))." 
                ".anchor(site_url('kelolamenu/delete/$1'),'<i class="mdi mdi-delete-sweep" aria-hidden="true"></i>','class="btn btn-danger btn-circle btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_menu');

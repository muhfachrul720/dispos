        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?= base_url()?>pegawai/json_verifcuti', "type": "POST", data : {'id' : <?= $this->session->userdata('id_pegawai')?>}},
                    columns: [
                        ...
                        {"data" : 'status_cuti'},
                        {
                            ...
                            "render" : function(data, type, row){
                                return '<a href="<?=base_url()?>pegawai/tinjau_cuti/'+data+'" class="btn btn-sm btn-primary">Tinjau</a>' ;
                            }
                        },
                    ],
                    order: [[0, 'asc']],

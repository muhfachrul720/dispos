<div class="card border-top-0 mb-3 pt-3 px-3 pb-1">
                <div class="card-body">
                    <h3 class="">Tinjau Pengajuan Kenaikan Pangkat Jabatan Fungsional </h3>
            ...
            <?php $checker = array(
                ...
                array('<b>Foto Kopi Sah</b> SK Jabatan Fungsional Tertentu'),
                array('<b>Foto Kopi Sah</b> SK Pembebasan sementara dan pengangkatan kembali dalam JFT'),
                array('<b>SKP, Capaian SKP, dan Penilaian Prestasi Kerja</b> (2 Tahun terakhir <b>sekurang-kurangnya bernilai baik</b>'),
                array('Penilaian Angka Kredit <b>Asli</b> (PAK)'),
            );?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <?=  form_hidden('id', $id_ajuan_fungsional); ?> 
                                <div class="col-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php 
                                        ...
                                        $path = base_url().'upload/berkas_naikpangkat/fungsional/pegawai_'.$id_pegawai.'tgl_'.substr(str_replace(':','_',$waktu_pengajuan_fungsional), 2);
                                    ?>
                                    <div class="row mb-3">
                                        <div class="col-7">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                            ...
                                            <?php echo form_dropdown('status', array('1' => 'Disetujui', '2' => 'Ditolak', '3' => 'Perlu Dikoreksi'), $status_pengajuan_fungsional, array('class' => 'form-control form-control-sm')); ?>
                                        </div>
                                        <div class="col-12 mb-2">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="<?= base_url()?>/pegawai/verifikasi_naikpangkat_fungsional" class="btn btn-secondary" style="width:49%">Kembali</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

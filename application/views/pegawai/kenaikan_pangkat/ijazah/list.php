<div class="container-fluid">
    <div class="card shadow mb-4 p-5" style="font-size:14px">
        ...
        <div class="header">
            <h3 class="mb-3">List Ajuan Kenaikan Pangkat Jabatan ijazah</h3>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?= base_url()?>pegawai/json_naikpangkat_ijazah', "type": "POST", data : {'id' : <?= $this->session->userdata('id_pegawai')?>}},
                    columns: [
                        ...
                        {"data" : 'keterangan_pengajuan_ijazah'},
                        {
                            ...
                            "render" : function(data, type, row){
                               return '<a href="<?= base_url() ?>pegawai/tinjau_naikpangkat_ijazah/'+data+'" class="btn btn-primary btn-sm w-50"><i class="mdi mdi-pencil" style="font-size:14px"></i> &nbsp Tinjau</a>';
                            }
                        },
                    ],
                    order: [[0, 'asc']],

<div class="card border-top-0 mb-3 pt-3 px-3 pb-1">
                <div class="card-body">
                    <h3 class="">Tinjau Pengajuan Kenaikan Pangkat Jabatan Struktural </h3>
            ...
            <?php $checker = array(
                array('<b>Foto Kopi Sah</b> SK Pangkat Terakhir'),
                array('<b>Foto Kopi Sah</b> SK Jabatan'),
                array('<b>Foto Kopi Sah</b> Surat Pernyataan Pelantikan'),
                array('<b>Foto Kopi Sah</b> Surat Pernyataan Meduduki Jabatan'),
                array('<b>Foto Kopi Sah</b> Surat Perintah Melaksanakan Tugas'),
                array('<b>SKP, Capaian SKP, dan Penilaian Prestasi Kerja</b> (2 Tahun terakhir <b>sekurang-kurangnya bernilai baik</b>'),
            );?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <?=  form_hidden('id', $id_ajuan_struktural); ?> 
                                <div class="col-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php 
                                        ...
                                        $path = base_url().'upload/berkas_naikpangkat/struktural/pegawai_'.$id_pegawai.'tgl_'.substr(str_replace(':','_',$waktu_pengajuan_struktural), 2);
                                    ?>
                                    <div class="row mb-3">
                                        <div class="col-7">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                            ...
                                            <?php echo form_dropdown('status', array('1' => 'Disetujui', '2' => 'Ditolak', '3' => 'Perlu Dikoreksi'), $status_pengajuan_struktural, array('class' => 'form-control form-control-sm')); ?>
                                        </div>
                                        <div class="col-12 mb-2">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="<?= base_url()?>/pegawai/verifikasi_naikpangkat_struktural" class="btn btn-secondary" style="width:49%">Kembali</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

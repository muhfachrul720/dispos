...
<?php if($id_kat_jbt_struktur == 0) {
        if($id_kategori_jabatan_fung == 0){    
?>  
    <div class="container-fluid">
        <h2 style="text-align:center; margin-top:20vh">Hanya Pegawai Yang Memegang Salah Satu Jabatan Fungsional <br> Yang Dapat Mengajukan Kenaikan Pangkat Jabatan Fungsional</h2>
    </div>
<?php } else {?> 
    <div class="container-fluid">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane show active fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <?php $checker = array(
                    ...
                    array('<b>Foto Kopi Sah</b> SK Jabatan', 'skjab'),
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <?php echo cmb_dinamis('usuljab', 'tbl_kategori_jabatan_struktur', 'nama_jabatan_struktur', 'id_kat_jbt_struktur', '', 'DESC') ?>
                                    </div>
                                </div>
                                <hr>
                                ...
                                columns: [
                                    ...
                                    {"data" : 'username'},
                                    {
                                        ...
                                        "render" : function(data, type, row){
                                            ...
                                            else if(row.status_pengajuan_struktural == 1) {

<div class="card border-top-0 mb-3 pt-3 px-3 pb-1">
    <div class="card-body">
        <h3 class="">Tinjau Pengajuan Kenaikan Pangkat Penyesuaian Reguler </h3>
        <p>Halaman Untuk Meninjau Pengajuan Pengajuan Kenaikan Pangkat</p>
    </div>
</div>  
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <?=  form_hidden('id', $id_ajuan_reguler); ?> 
                    <div class="col-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php 
                            ...
                            $path = base_url().'upload/berkas_naikpangkat/reguler/pegawai_'.$id_pegawai.'tgl_'.substr(str_replace(':','_',$waktu_pengajuan_reguler), 2);
                        ?>
                        <div class="row mb-3">
                            <div class="col-7">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 mb-2">
                                ...
                                <?php echo form_dropdown('status', array('1' => 'Disetujui', '2' => 'Ditolak', '3' => 'Perlu Dikoreksi'), $status_pengajuan_reguler, array('class' => 'form-control form-control-sm')); ?>
                            </div>
                            <div class="col-12 mb-2">
                            ...
                            <div class="col-12">
                                ...
                                <a href="<?= base_url()?>/pegawai/verifikasi_naikpangkat_reguler" class="btn btn-secondary" style="width:49%">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>

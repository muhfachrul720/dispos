...
<?php if(notif_kenaikanreguler($tmt_pangkat_terakhir) == false) {?>
    <div class="container-fluid">
        <h2 style="text-align:center; margin-top:20vh">Anda Belum Memenuhi Syarat 4 Tahun Menjabat Pangkat Golongan Untuk Mengajukan Kenaikan Pangkat Reguler / KPO </h2>
    </div>
<?php } else {?>
    <div class="container-fluid">
        ...
        <div class="tab-content" id="myTabContent"> 
            <div class="tab-pane show active fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <?php $checker = array(
                    array('<b>Foto Kopi Sah</b> SK Pangkat Terakhir', 'sk_pangkat'),
                    array('<b>Foto Kopi Sah</b> SKP, Capaian SKP, Penilaian Prestasi Kerja (2 Tahun terakhir Sekurang kurangnya bernilai baik)', 'skp'),
                );?>

                <?php if(isset($aju)){ 
                    echo form_hidden('time', $aju['waktu_pengajuan_reguler']);
                    echo form_hidden('id', $aju['id_ajuan_reguler']);
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table id="history" style="font-size:12px; width:100%" class="table table-striped table-bordered table-sm text-center" style="width:100%">
                                                <thead>
                                                <tr>
                                                    <th width="">No</th>
                                        ...
                                        <script type="text/javascript">
                                                $(document).ready(function() {
                                                    ...
                                                    var t = $("#history").dataTable({
                                                        ...
                                                        processing: true,
                                                        serverSide: true,
                                                        ajax: {"url": "<?= base_url()?>pegawai/json_panghir_bypegawai", "type": "POST", data : { id : <?= $this->session->userdata('id_pegawai')?>}},
                                                        columns: [
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var t = $("#example").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": '<?= base_url()?>dashboard_p/json_naikpangkat_reguler', "type": "POST", data : {'id' : <?= $this->session->userdata('id_pegawai')?>}},
                                columns: [
                                    {"data" : 'waktu_pengajuan_reguler', orderable:false},
                                    {"data" : 'waktu_pengajuan_reguler'},
                                    {
                                        "data" : 'status_pengajuan_reguler',
                                    ...
                                    {"data" : 'keterangan_pengajuan_reguler'},
                                    {"data" : 'username'},
                                    {
                                        "data" : 'id_ajuan_reguler',
                                        "render" : function(data, type, row){
                                            if(row.status_pengajuan_reguler == 3){
                                                return "<a href='<?= base_url('dashboard_p/ajuan_naikpangkat_reguler/')?>/"+data+"' class='btn btn-warning btn-sm'>Edit</a>";
                                            }
                                            else if(row.report_pengajuan_reguler != null) {
                                                return "<a href='<?= base_url()?>upload/report_naikpangkat/reguler/"+row.report_pengajuan_reguler+"' class='btn btn-success btn-sm' download>Download SK</a>";
                                            }
                                            else {
                                                return '';
                                            };

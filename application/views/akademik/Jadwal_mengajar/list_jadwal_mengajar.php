        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?= base_url()?>akademik/json_jadwal_mengajar', "type": "POST"},
                    columns: [
                        ...
                        {"data" : 'nama_lengkap_peg'},
                        {
                            ...
                            "render" : function(data, type, row){
                                return '<a href="<?= base_url()?>akademik/form_jadkul/'+data+'" class="btn btn-sm btn-warning mx-2"><i class="mdi mdi-pencil"></i></a><a href="<?= base_url()?>akademik/hapus_jadkul/'+data+'" class="btn btn-sm btn-danger"><i class="mdi mdi-delete"></i></a>' ;
                            }
                        },
                    ],
                    order: [[0, 'asc']],

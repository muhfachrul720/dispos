...
<head>
  ...
  <link href="<?php echo base_url(); ?>assets/assets-sbadmin/css/sb-admin-2.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <!-- <div class="alert alert-danger mt-3 font-weight-bold" style="margin-left: 430px;" role="alert">
           <span style="color: red;">Penyerapan Anggaran akan selesai dalam <span style="font-size: 25px;">30</span> hari lagi !!!</span>
          </div> -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 font-weight-bold"><?php echo $this->session->userdata('full_name'); ?></span>
               <?php if ($this->session->userdata('images') == NULL): ?>
                    <img class="img-profile rounded-circle" src="<?php echo base_url() ?>assets/foto_profil/atomix_user31.png ?>">
                <?php else: ?>
  ...
  <!-- Page level plugins -->
  <script src="<?php echo base_url(); ?>assets/assets-sbadmin/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo base_url(); ?>assets/assets-sbadmin/js/demo/chart-area-demo.js"></script>
  <script src="<?php echo base_url(); ?>assets/assets-sbadmin/js/demo/chart-pie-demo.js"></script>
